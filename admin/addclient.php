...
if(isset($_POST['submit']))
  {
	...
	$sql="Insert into clients (Insured_Name,Reference_Tagging,Contact_No1,Contact_No2,Client_Location,Net_Amount,Gross_Amount,Discount,Plan,Person_Covered,Age_of_Eldest_Person,Portability,Medical,Amount_Covered,CI_Cover,Deductible,Period_Covered,Auto_Renewal,Pickup_Date,Month,Sourced_By,Agent_Code,Status,Rejection_Reason,Loading,Policy_No,Claim_1,Claim_2,Claim_3,xCaller,xCaller_Code,Company,Mail_Id_2,Mobile_in_Form,Annual_Income,Occupation,Address)
...
<div class="col-sm-4">
<input type="text" name="Insured_Name" class="form-control" required value="">
</div>
<label class="col-sm-2 control-label">Reference Tagging</label>
<div class="col-sm-4">
<input type="text" name="Reference_Tagging" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Contact_No1" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Contact No.2</label>
<div class="col-sm-4">
<input type="text" name="Contact_No2" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Client_Location" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Net_Amount" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Gross Amount</label>
<div class="col-sm-4">
<input type="text" name="Gross_Amount" class="form-control" value="">
</div>
...
<div class="col-sm-4">
<input type="text" name="Person_Covered" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Age of Eldest Person</label>
<div class="col-sm-4">
<input type="text" name="Age_of_Eldest_Person" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Portability" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Medical</label>
<div class="col-sm-4">
<input type="text" name="Medical" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Amount_Covered" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">CI Cover</label>
<div class="col-sm-4">
<input type="text" name="CI_Cover" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Deductible" class="form-control" value="">
</div>
...
<div class="col-sm-4">
<input type="text" name="Auto_Renewal" class="form-control" value="">
</div>
...
<div class="col-sm-4">
<input type="text" name="Sourced_By" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Agent Code</label>
<div class="col-sm-4">
<input type="text" name="Agent_Code" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Rejection_Reason" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Loading" class="form-control" value="">
</div>
...
<div class="col-sm-4">
<input type="text" name="Claim_1" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Claim 2</label>
<div class="col-sm-4">
<input type="text" name="Claim_2" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Claim 3</label>
<div class="col-sm-4">
<input type="text" name="Claim_3" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Caller" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Caller Code</label>
<div class="col-sm-4">
<input type="text" name="Caller_Code" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Mail_Id_2" class="form-control" value="">
</div>
<label class="col-sm-2 control-label">Mobile in Form</label>
<div class="col-sm-4">
<input type="text" name="Mobile_in_Form" class="form-control" value="">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="Annual_Income" class="form-control" value="">
</div>
...
<div class="col-sm-4">
<textarea rows="5"  name="Address" class="form-control" value=""></textarea>
</div>
</div>
<!-- _______________________________________________________________________________________________________________ -->
