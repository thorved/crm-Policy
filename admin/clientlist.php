...
<?php $sql = "SELECT id,Insured_Name,Reference_Tagging,Plan,Pickup_Date,Sourced_By,Company,Contact_No1,Contact_No2,Mobile_in_Form from clients ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											<td><?php echo htmlentities($cnt);?></td>
														...
														<td><a href="clientdetail-selected.php?cid=<?php echo $result->id;?>">
											...
											<td><?php echo htmlentities($result->Contact_No1);?><br><?php echo htmlentities($result->Contact_No2);?><br><?php echo htmlentities($result->Mobile_in_Form);?> </td>
