...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE users SET caller_code=(:caller_code),name=(:name), email=(:email), gender=(:gender), mobile=(:mobileno), designation=(:designation), Image=(:image) ".$password." WHERE id=(:idedit)";
...
<div class="form-group">
<label class="col-sm-2 control-label">Worker Code<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="caller_code" class="form-control" required value="<?php echo htmlentities($result->caller_code);?>">
</div>

							
                            <label class="col-sm-2 control-label">Password<span style="color:red">*</span></label>
                            <div class="col-sm-4">
                            <input type="password" name="password" class="form-control" id="password" required value="null" >
							</div>
...
<select name="gender" class="form-control" required>
                            ...
                            <option <?php if ($result->gender == "Male" ) echo "selected='selected'";?> value="Male">Male</option>
                            <option <?php if ($result->gender == "Female" ) echo "selected='selected'";?> value="Female">Female</option>
                            </select>
</div>
