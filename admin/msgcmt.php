...
<body>
<?php
		$sql = "SELECT clients.Insured_Name,clients.Caller,users.email from clients,users where clients.id=(:cid) and users.caller_code=(:wid)";
		$query = $dbh -> prepare($sql);
		$query-> bindParam(':cid', $cid, PDO::PARAM_STR);
		$query-> bindParam(':wid', $wid, PDO::PARAM_STR);
		$query->execute();
...
<div class="form-group">
	<label class="col-sm-2 control-label">Worker<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="Caller" class="form-control" readonly required value="<?php echo htmlentities($result->Caller);?>">
	</div>
</div>	
<div class="form-group">
	<label class="col-sm-2 control-label">Client<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="Insured_Name" class="form-control" readonly required value="<?php echo htmlentities($cname);?>">
	</div>
</div>
