...
{
	if($_POST['wcaction']=="all")
	{
		$wcaction='';
	}
	else{
		$wcaction=' and clients.wcaction="'.$_POST['wcaction'].'"';
	}
}
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"><i class="fa fa-users"></i> &nbsp;Completed Work</h3>
							...
							<form method="post" class="form-horizontal" enctype="multipart/form-data" name="selectclientsbyworkers">
								<div class="form-group">
									...
									<label class="col-sm-1 control-label">Worker Action<span style="color:red">*</span></label>
									<div class="col-sm-4">
										<select name="wcaction" class="form-control" required>

											<option value="all">All</option>
											<option <?php if ($_POST['wcaction'] == "Wrong number") echo "selected='selected'";?> value="Wrong number">Wrong number</option>
											<option <?php if ($_POST['wcaction'] == "Lead Closed") echo "selected='selected'";?> value="Lead Closed">Lead Closed</option>
											<option <?php if ($_POST['wcaction'] == "Not interested") echo "selected='selected'";?> value="Not interested">Not interested</option>
										...
										<tbody>
											...
											<?php
												...
												if ($_POST['worker'] == "all" || $_POST['worker'] == null) {
													$sql = "SELECT id,Insured_Name,Reference_Tagging,Plan,Pickup_Date,Sourced_By,Company,Caller,wcaction from  clients  WHERE (clients.wcaction='Wrong number' OR clients.wcaction='Lead Closed' OR clients.wcaction='Not interested')".$wcaction;
												} else {
													$sql = "SELECT id,Insured_Name,Reference_Tagging,Plan,Pickup_Date,Sourced_By,Company,Caller,wcaction from  clients WHERE Caller_Code=(:caller_code) and (clients.wcaction='Wrong number' OR clients.wcaction='Lead Closed' OR clients.wcaction='Not interested')".$wcaction;
												}
											...
											<td><?php echo htmlentities($result->wcaction); ?></td>
<!--<td>
