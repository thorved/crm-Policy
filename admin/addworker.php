...
$sql ="INSERT INTO users(caller_code,name,email, password, gender, mobile, designation, image, status) VALUES(:caller_code,:name, :email, :password, :gender, :mobileno, :designation, :image, 1)";
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title"><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp;Add Worker</h3>
						<div class="row">
							<div class="col-md-12">
                         ...
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <option value="Male"><i class="fa fa-male" aria-hidden="true"></i>Male</option>
                            <option value="Female"><i class="fa fa-female" aria-hidden="true"></i>Female</option>
                            </select>
                            </div>
							...
							<label class="col-sm-1 control-label">Worker Code<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            <div><input type="text" name="caller_code" class="form-control"></div>
                            </div>
                            </div>
