...
<head>
	...
	<title>Selected Comment's</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"><i class="fa fa-comment" aria-hidden="true"></i> &nbsp;Selected Comment's</h2>
...
$sql = "SELECT * from msgcmt where cid=(:cid) order by time desc";
