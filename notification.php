...
$sql = "delete from  notification where notireciver = (:reciver)";
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title"><i class="fa fa-bell"></i> &nbsp;Notifications&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" name="submit" type="submit">Clear Notifications</button></h3>
					</form>
						<div class="row">
							<div class="col-md-12">
